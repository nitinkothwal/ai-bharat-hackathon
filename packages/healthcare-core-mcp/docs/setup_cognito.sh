...
# https://cognito-idp.us-east-1.amazonaws.com/us-east-1_3sYIp6FRs/.well-known/openid-configuration
# agentcore configure -e http://localhost:8000/sse --transport sse --protocol MCP